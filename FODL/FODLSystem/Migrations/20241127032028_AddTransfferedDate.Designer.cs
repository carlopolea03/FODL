...
namespace FODLSystem.Migrations
{
    ...
    [Migration("20241127032028_AddTransfferedDate")]
    partial class AddTransfferedDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FODLSystem.Models.BSmartEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("BSmartShiftId");
                    ...
                    b.ToTable("BSmartEquipments");
                });

            modelBuilder.Entity("FODLSystem.Models.BSmartError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("BSmartErrors");
                });

            modelBuilder.Entity("FODLSystem.Models.BSmartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("BSmartEquipmentId");
                    ...
                    b.Property<decimal>("VolumeQty");

                    b.HasKey("Id");

                    b.HasIndex("BSmartEquipmentId");

                    b.HasIndex("ComponentCode");

                    b.HasIndex("ItemNo");

                    b.ToTable("BSmartItems");
                });

            modelBuilder.Entity("FODLSystem.Models.BSmartShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FODLSystem.Models.FuelOil", b =>
                {
                    ...
                    b.Property<bool>("GeneratedfromBSmart");
            ...
            modelBuilder.Entity("FODLSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CompanyAccess = "1", Domain = "SMCDACON", Email = "jrventura@semirarampc.com", FirstName = "jrventura", LastName = "jrventura", Name = "jrventura", Password = "", RoleId = 1, Status = "1", Username = "jrventura" }
                    );
                });

            modelBuilder.Entity("FODLSystem.Models.BSmartEquipment", b =>
                {
                    b.HasOne("FODLSystem.Models.BSmartShift", "BSmartShift")
                        .WithMany("BSmartEquipment")
                        .HasForeignKey("BSmartShiftId")
            ...
            modelBuilder.Entity("FODLSystem.Models.BSmartItem", b =>
                {
                    b.HasOne("FODLSystem.Models.BSmartEquipment", "BSmartEquipment")
                        .WithMany("BSmartItems")
                        .HasForeignKey("BSmartEquipmentId")
                        .OnDelete(DeleteBehavior.Cascade);
