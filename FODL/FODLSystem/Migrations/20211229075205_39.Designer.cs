            ...
            modelBuilder.Entity("FODLSystem.Models.Component", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DateModified = new DateTime(2021, 12, 29, 15, 52, 5, 36, DateTimeKind.Local), Name = "N/A", Status = "Default" }
                    );
                });
            ...
            modelBuilder.Entity("FODLSystem.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, IdNumber = "00000", Name = "N/A", Position = "N/A", Status = "Enabled" }
                    );
                });
