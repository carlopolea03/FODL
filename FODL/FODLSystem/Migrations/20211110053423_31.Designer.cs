            ...
            modelBuilder.Entity("FODLSystem.Models.Component", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DateModified = new DateTime(2021, 11, 10, 13, 34, 23, 343, DateTimeKind.Local), Name = "N/A", Status = "Default" }
                    );
                });
            ...
            modelBuilder.Entity("FODLSystem.Models.FuelOil", b =>
                {
                    ...
                    b.HasIndex("TransactionDate", "Shift", "Status", "LubeTruckId", "DispenserId")
                        .IsUnique()
