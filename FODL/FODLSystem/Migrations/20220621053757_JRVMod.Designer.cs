...
namespace FODLSystem.Migrations
{
    ...
    [Migration("20220621053757_JRVMod")]
    partial class JRVMod
    {
            ...
            modelBuilder.Entity("FODLSystem.Models.Component", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DateModified = new DateTime(2022, 6, 21, 13, 37, 57, 85, DateTimeKind.Local), Name = "N/A", Status = "Default" }
                    );
                });
            ...
            modelBuilder.Entity("FODLSystem.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new { IdNumber = "00000", DateModified = new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ID = 1, Name = "N/A", Position = "N/A", Status = "Enabled" }
                    );
                });
            ...
            modelBuilder.Entity("FODLSystem.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new { No = "na", Id = 1, List = "N/A", OfficeCode = "000", Status = "Default" }
                    );
                });
